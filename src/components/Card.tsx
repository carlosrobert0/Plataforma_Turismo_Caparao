    ...
    <div role="listitem" className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
      <div className="rounded overflow-hidden shadow-md bg-white">
        ...
        <div className="px-6 mt-16">
          ...
          <p className="text-gray-800 text-sm text-center">{profession}</p>
          <p className="text-center text-gray-600 text-base pt-3 font-normal">{description}</p>
          <div className="w-full flex justify-center pt-5 pb-5">
            <a href={githubUrl} className="mx-5">
            ...
            <a href={twitterUrl} className="mx-5">
            ...
            <a href={instagramUrl} className="mx-5">
