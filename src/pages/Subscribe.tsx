...
export function Subscribe() {
  ...
  return (
    <div className="min-h-screen bg-blur relative bg-cover bg-no-repeat flex flex-col items-center">
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        <div className="max-w-[640px]">
          ...
          <h1 className="mt-8 text-[2.5rem] leading-tight">
            Construa uma <strong className="text-blue-500">experiência completa</strong>, com <strong className="text-blue-500">Plataforma de turismo Caparaó</strong>
          </h1>
          <p className="mt-4 text-gray-200 leading-relaxed">
            Com nossas rotas turísticas você vai conhecer os melhores destinos da região do caparaó exclusivamente o terceiro maior pico do Brasil, O Pico da Bandeira.
          </p>
        </div>
      ...
      <img src={pico} className="mt-10" alt="" />
    </div>
  )
}